...
public class UsableRedpacketFragment extends Fragment {
    private View view;
    ...
    private void addData() {
        ...
        //0未生效1已生效2已过期3已使用 ，多个状态用英文逗号相隔，不传获取所有
        params.putString("status", "0,1");
        params.putString("pageNum", pageStart + "");
        ...
        mHttp.post(Url.USERREDINFO_URL, params, new JsonInterface() {
            ...
            public void callback(String result) {
                ...
                if (code == 0) {
                    pageNum = redpacketData.getData().getPageNum();
