...
public class AsiaOddsDetailActivity extends BaseNoTitleActivity {
    private TitleBar mTitlBar;
    private ListView mCompany_lv;
    private ListView mOdds_lv;
    List<OddsData.DataBean.ItemsBean> mCompanyList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asia_odds_detail);
        ...
        mOddsDetailAdapter = new OddsDetailAdapter(mContext, mOddsList,2);
    ...
    private void addData() {
        ...
        mHttp.get(Url.ASIAODDS_DETAIL, params, new JsonInterface() {
            @Override
