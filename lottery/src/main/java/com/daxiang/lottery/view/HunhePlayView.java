 ...
 */
public class HunhePlayView extends RelativeLayout {
    ...
    public HunhePlayView(Context context) {
        super(context);
        this.mContext = (Activity) context;
    }

    public HunhePlayView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = (Activity) context;
    }

    public HunhePlayView(Activity activity, JczqData.DataBean dataBean, HashMap<String, String> hasChoosedMap, OnOddsChooseFinishListener onOddsChooseFinishListener) {
        super(activity);
    ...
    protected void initHeadview() {
        ...
        popHostView.setText(dataBean.getHomeTeam());
        popGuestView.setText(dataBean.getGuestTeam());
            ...
            if (hasChoosedMap != null) {
                for (String layoutText : hasChoosedMap.keySet()) {
                    ...
                    if (layoutText.equals(titleTextView.getText().toString())) {
                        ...
                        ll.setBackgroundResource(R.color.jc_red);
            ...
            ll.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (status == 1) {
                        ...
                        oddTextView.setTextColor(mContext.getResources().getColor(R.color.white));
...
//                        }
                        ...
                        titleTextView.setTextColor(mContext.getResources().getColor(R.color.txt_middle));
                        oddTextView.setTextColor(mContext.getResources().getColor(R.color.txt_middle));
