...
public class JcBuyBottomViewForecast  extends LinearLayout {
    ...
    public JcBuyBottomViewForecast(Context context) {
        super(context);
        mInflate = View.inflate(context, R.layout.cx_jc_choosed_bottom_view_forecast, this);
    }

    public JcBuyBottomViewForecast(Context context, AttributeSet attrs) {
        super(context, attrs);
        mInflate = View.inflate(context, R.layout.cx_jc_choosed_bottom_view_forecast, this);
    }
