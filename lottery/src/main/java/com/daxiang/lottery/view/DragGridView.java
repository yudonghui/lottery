...
public class DragGridView extends GridView implements AdapterView.OnItemLongClickListener {
    ...
    private void initWindow() {
        if (dragView == null) {
            dragView = View.inflate(mContext, R.layout.drag_item, null);
            ...
            ImageView mImageToday = (ImageView) dragView.findViewById(R.id.todaykaijiang);
            ...
            mImageToday.setImageDrawable(((ImageView) view.findViewById(R.id.todaykaijiang)).getDrawable());
        }
