...
public class FloatViewLayout extends RelativeLayout {
    ...
    private MoveListener mMoveListener;//距离左边的距离监听

    public void setMove(MoveListener mMoveListener) {
    ...
    private void init() {
        viewDragHelper = ViewDragHelper.create(this, new ViewDragHelper.Callback() {
            ...
            public boolean tryCaptureView(View child, int pointerId) {
                //  Log.e("位置PositionHorizontal",child.getLeft()+"");
                return true;
            }
            ...
            public int getViewVerticalDragRange(View child) {
                // Log.e("位置：", "左" + child.getLeft() + "上" + child.getTop() + "右" + child.getRight() + "底" + child.getBottom());
                return getHeight();
            }
        });
    }
